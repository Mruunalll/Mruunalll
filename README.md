...
Hi, I'm **Mrunal Patil** — a **Manual QA Engineer | Automation Testing Engineer | SDET | Aspiring QA AI Testing Enthusiast** focused on high-quality web, mobile, WordPress, and AI application testing.
...
| Project | Platform | Test Cases | Bugs Found | Focus Areas |
|---------|----------|-----------:|-----------:|-------------|
...
**Coverage total:** 97 test cases executed · 181 SureForms test cases planned · 33 defects identified · 9 exploratory charters · 3 RTMs · Playwright + Docker automation added

---

## 🔍 What I Do

- Execute manual testing across web, mobile, WordPress, and AI applications
- Design structured test cases with clear preconditions, steps, and expected results
- Document high-signal bug reports with severity, priority, environment, and business impact
- Build RTMs that map requirements to test coverage and defects
- Run exploratory testing sessions using SBTM-style charters
- Build Playwright automation with page objects, reusable test data, Docker execution, and clear WIP reporting
- Transition toward deeper API testing, CI, and security-minded QA practices
