...
|---|---|---|---|---|
| [SureForms Plugin QA Suite](https://github.com/Mruunalll/SureForms-Plugin-Test-Suite-Manual-Automation) | Manual + AI Testing | 500+ | WIP | AI form generation, E2E, smoke, sanity, negative, payment flows |
| [AI Application QA Suite](https://github.com/Mruunalll/ai-application-qa-test-suite) | Manual · Exploratory | 32 | 11 | Prompt/response validation, hallucination risk, session state, file upload |
| [WooCommerce E-Commerce QA](https://github.com/Mruunalll/ecommerce-manual-qa-test-suite) | Manual · RTM · Mobile | 35 | 12 | Cart, checkout, coupons, mobile UX, compatibility |
| [Web App Security Testing](https://github.com/Mruunalll/wordpress-astra-qa-test-suite) | OWASP · Postman | — | — | SQLi, XSS, IDOR, broken auth, PoC documentation |
